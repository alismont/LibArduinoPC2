...
#ifndef defaults_h
// Grbl for Labsud CNC #define MOTOR_STP 200 
// number of step per turn #define MICRO_STP 1 
// Micro stepping 1 step #define SCREW_PITCH_MM 1.25 // Screw pitch in mm //
#ifdef DEFAULTS_GENERIC
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 50.0
  (MICRO_STP*MOTOR_STP/SCREW_PITCH_MM)
