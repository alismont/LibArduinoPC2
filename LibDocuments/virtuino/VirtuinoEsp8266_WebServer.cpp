/* Virtuino ESP8266 web server Library ver 1.44
...
//====================================================================== setESP8266_mode
bool VirtuinoEsp8266_WebServer::esp8266_baud(long baud){
    clearESP_buffer(100);    // clear esp buffer
    ...
    if (c=='\n') {                                            // check command line to line
          ...
          if (pos>=0){                                        // check for GET command from Virtuino app
              ...
              if (pos!=-1){                                   // We have a GET message
                  String response = checkNetworkCommand(commandBuffer.substring(pos+5));
      ...
      case 'Q': 
       ...
       case 'O': 
        ...
        //         connectedStatus=true;
                 response ="!C"+pinString+"="+firmwareCode+"$";
               }
